...
Folder: `/Users/macbook/Викачане/#1/MD/`
File:   `/Users/macbook/Викачане/#1/MD/SESSION_<YYYY-MM-DD>.md`  (date = today)
...
3. **Check for an existing journal for today:**
   `ls -la "/Users/macbook/Викачане/#1/MD/SESSION_$(date +%Y-%m-%d).md" 2>/dev/null`
...
5. **Ensure the folder exists, then write the file** (mkdir is idempotent; quote
   the path):
   `mkdir -p "/Users/macbook/Викачане/#1/MD"`
   Write the journal to `"/Users/macbook/Викачане/#1/MD/SESSION_<date>.md"`.

6. **Confirm** (real output):
   - Print the full path of the written file
   - `wc -c "/Users/macbook/Викачане/#1/MD/SESSION_<date>.md"` (size)
   - `ls -la "/Users/macbook/Викачане/#1/MD/"` (prove the file is there)
