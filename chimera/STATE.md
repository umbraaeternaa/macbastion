...
- Native (shim Unity): 30 passing (11 ops + 6 peercred + 2 server + 8 protocol [incl 4 secret-gating] + 3 secret — per-boot secret + destructive-op gating, SS-2/3) — separate C trust-plane suite, NOT in pytest
