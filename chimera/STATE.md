...
NEXT: secret-gen + main.c (root-free), then real pfctl/dnctl on live pf — per-command root approval. Distribution also shipped this session: `setup.sh` one-command clone-and-run
