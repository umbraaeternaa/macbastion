...
#ifndef MIRROR_JSONRPC_H
#define MIRROR_JSONRPC_H
...
/* Parse one NDJSON line into a request. On MIRROR_OK, *out is owned (free with
 * jsonrpc_request_free). MIRROR_ERR_PARSE on malformed input or a missing method. */
