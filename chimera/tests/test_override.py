...
Hermetic: override.json under tmp_path. RED — the methods raise NotImplementedError until
GREEN. Pins: set->verify true, wrong phrase false, no-phrase-set false (override unavailable
